...
class ClipPostController extends Controller
{
    ...
    public function store(Clip $clip, Request $request)
    {
        ...
        $request->validate([
            ...
            'template_name' => [
                'required',
                'in:petjeaf-insta-purple,petjeaf-insta-light,petjeaf-reel-purple,petjeaf-reel-light,video-petjeaf-insta,video-petjeaf-insta-light,video-petjeaf-reel,video-petjeaf-reel-light,video-petjeaf-insta-keep-ratio'
            ],
        ]);
